var _typeof2 = require("../wx-open-data-project/@babel/runtime/helpers/typeof");
...
!function r(o, i, a) {
    ...
    2: [ function(e, t, n) {
        "use strict";
        var r = window.fsUtils, o = r.getUserDataPath, i = r.readJsonSync, c = r.makeDirSync, a = r.writeFileSync, s = r.copyFile, l = r.downloadFile, u = r.writeFile, f = r.deleteFile, d = r.rmdirSync, p = r.unzip, h = r.isOutOfStorage, m = !1, y = null, g = !1, v = [], b = [], w = !1, _ = 0, E = /^https?:\/\/.*/;
        cc.assetManager.cacheManager = t.exports = {
            ...
            writeCacheFile: function writeCacheFile(e) {
                y ? e && b.push(e) : (y = setTimeout(this._write.bind(this), this.writeFileInterval), 
                !0 === g ? e && v.push(e) : e && b.push(e));
            },
    ...
    3: [ function(e, t, n) {
        "use strict";
        var r, s, l = e("../cache-manager"), o = window.fsUtils, f = o.fs, d = o.downloadFile, i = o.readText, a = o.readArrayBuffer, c = o.readJson, p = o.loadSubpackage, h = o.getUserDataPath, u = o.exists, m = /^https?:\/\/.*/, y = {}, g = cc.assetManager.downloader, v = cc.assetManager.parser, e = cc.assetManager.presets, b = __globalAdapter.isSubContext;
        ...
        var j = v.parsePVRTex, R = v.parsePKMTex;
        e = b ? function(e, t, n) {
            n(null, e = L(e, t).url);
        } : C;
        g.downloadDomAudio = x, g.downloadScript = E, v.parsePVRTex = P, v.parsePKMTex = D, 
        g.register({
            ".js": E,
            ".mp3": C,
            ".ogg": C,
            ...
            bundle: function bundle(e, t, a) {
                ...
                if (w[r]) {
                    ...
                    m.test(e) || !b && e.startsWith(h()) ? (c = e, n = "src/scripts/".concat(r, "/index.js"), 
        ...
        b ? (I = cc.assetManager.init, cc.assetManager.init = function(e) {
    ...
    17: [ function(e, t, n) {
        ...
        function B(e, t) {
            ...
            return U(this, r, e, t, n = a && null == i && null == (i = o.lookupPrefix(a)) ? [ {
                namespace: a,
                prefix: null
            } ] : n), r.join("");
        }
            ...
            switch (e.nodeType) {
              case 1:
                ...
                for (var l, f, d, s = 0; s < a; s++) {
                    W(l = i.item(s), 0, o) && (f = l.prefix || "", d = l.namespaceURI, t.push(f ? " xmlns:" + f : " xmlns", '="', d, '"'), 
                    o.push({
                        prefix: f,
                        namespace: d
                    })), U(l, t, n, r, o);
                }
                if (W(e, 0, o) && (f = e.prefix || "", d = e.namespaceURI, t.push(f ? " xmlns:" + f : " xmlns", '="', d, '"'), 
                o.push({
                    prefix: f,
                    namespace: d
                })), c || n && !/^(?:meta|link|img|br|hr|input)$/i.test(u)) {
                    if (t.push(">"), n && /^script$/i.test(u)) for (;c; ) {
                        c.data ? t.push(c.data) : U(c, t, n, r, o), c = c.nextSibling;
                    } else for (;c; ) {
                        U(c, t, n, r, o), c = c.nextSibling;
                    }
                    t.push("</", u, ">");
                } else t.push("/>");
                return;
        ...
        o(N, b), M.prototype.nodeType = 2, o(M, b), A.prototype = {
            ...
            nodeType: 4
        }, o(D, A), j.prototype.nodeType = 10, o(j, b), R.prototype.nodeType = 12, o(R, b), 
        I.prototype.nodeType = 6, o(I, b), L.prototype.nodeType = 5, o(L, b), F.prototype.nodeName = "#document-fragment", 
    ...
    19: [ function(e, t, n) {
        "use strict";
        var r = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, o = new RegExp("[\\-\\.0-9" + r.source.slice(1, -1) + "\\u00B7\\u0300-\\u036F\\u203F-\\u2040]"), i = new RegExp("^" + r.source + o.source + "*(?::" + r.source + o.source + "*)?$"), C = 0, P = 1, D = 2, j = 3, R = 4, I = 5, L = 6, F = 7;
        function a() {}
        function k(e, t) {
                    ...
                    for (;;) {
                        try {
                            ...
                            switch (h < g && t(g), n.charAt(g + 1)) {
                              case "/":
                                var v = n.indexOf(">", g + 3), b = n.substring(g + 2, v), w = d.pop();
                                v < 0 ? (b = n.substring(g + 2).replace(/[\s<].*/, ""), i.error("end tag name: " + b + " is not complete:" + w.tagName), 
                                v = g + 1 + b.length) : b.match(/\s</) && (b = b.replace(/[\s<].*/, ""), i.error("end tag name: " + b + " maybe not complete"), 
                                v = g + 1 + b.length);
                              ...
                              default:
                                f && c(g);
                                var O = new B(), S = d[d.length - 1].currentNSMap, v = function(e, t, n, r, o, i) {
                                    var a, c = ++t, u = C;
                                    for (;;) {
                                        var s = e.charAt(c);
                                        switch (s) {
                                          ...
                                          case '"':
                                            if (u === j || u === P) {
                                                if (u === P && (i.warning('attribute value must after "="'), a = e.slice(t, c)), 
                                          ...
                                          case ">":
                                            switch (u) {
                                              ...
                                              case D:
                                                u === D && (l = a), u == R ? (i.warning('attribute "' + l + '" missed quot(")!!'), 
                                ...
                                if (!O.closed && function(e, t, n, r) {
                                    ...
                                    r[n] = o);
                                    return o < t;
                                }(n, v, O.tagName, p) && (O.closed = !0, r.nbsp || i.warning("unclosed xml attribute")), 
                                f && T) {
                                    for (var N = k(f, {}), M = 0; M < T; M++) {
                                        var A = O[M];
                                        c(A.offset), A.locator = k(f, {});
                                    }
                                    o.locator = N, H(O, o, S) && d.push(O), o.locator = f;
                                } else H(O, o, S) && d.push(O);
                                "http://www.w3.org/1999/xhtml" !== O.uri || O.closed ? v++ : v = function(e, t, n, r, o) {
    ...
    48: [ function(e, t, n) {
        ...
        var o = x(e("./Canvas")), i = x(e("./navigator")), a = x(e("./XMLHttpRequest")), c = x(e("./WebSocket")), u = x(e("./Image")), s = x(e("./ImageBitmap")), l = x(e("./Audio")), f = x(e("./FileReader")), d = x(e("./HTMLElement")), p = x(e("./HTMLImageElement")), h = x(e("./HTMLCanvasElement")), m = x(e("./HTMLMediaElement")), y = x(e("./HTMLAudioElement")), g = x(e("./HTMLVideoElement")), v = x(e("./WebGLRenderingContext")), b = e("./EventIniter/index.js"), w = x(e("./localStorage")), _ = x(e("./location")), E = e("./WindowProperties");
        function x(e) {
            return e && e.__esModule ? e : {
                default: e
            };
    ...
    54: [ function(e, t, n) {
        "use strict";
        var r = !1, o = cc.game;
        o.once(o.EVENT_ENGINE_INITED, function() {
            r = !0;
        });
        var i = {
            x: 0,
        ...
        cc.view.convertToLocationInView = function(e, t, n, r) {
            r = r || cc.v2(), e = this._devicePixelRatio * (e - n.left), t = this._devicePixelRatio * (n.top + n.height - t), 
            e = (e - i.x) * this._viewportRect.width / i.width, t = (t - i.y) * this._viewportRect.height / i.height;
            return this._isRotated ? (r.x = this._viewportRect.width - t, r.y = e) : (r.x = e, 
            r.y = t), r;
        }, o._prepareFinished = function(e) {
            var t = this;
            this._prepared = !0, this._initEngine(), cc.assetManager.builtins.init(function() {
                console.log("Cocos Creator v" + cc.ENGINE_VERSION), t._setAnimFrame(), t.emit(t.EVENT_GAME_INITED), 
                e && e();
            });
        }, wx.onMessage(function(e) {
            e.fromEngine && ("boot" === e.event ? (o._banRunningMainLoop = !1, o._firstSceneLaunched && o._runMainLoop()) : "viewport" === e.event ? (i.x = e.x, 
            i.y = e.y, i.width = e.width, i.height = e.height) : "resize" === e.event ? window.dispatchEvent({
                type: "resize"
        ...
        var a = cc.Canvas.prototype.applySettings;
